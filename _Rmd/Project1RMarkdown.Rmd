...
Here we are graphing the results from the last 365 days. The closing average is definitely centered around the $280 price point. Looks like now (06/19/2022) would be a good time to buy some stock!
```{r}
